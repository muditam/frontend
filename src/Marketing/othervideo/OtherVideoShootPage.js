...
export default function OtherVideoShootPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const dItems = dRes.data.otherVideos || [];
  ...
  return (
    <Box sx={{ bgcolor: "#f8fafc", minHeight: "100vh", color: "#0f172a", p: 4 }}>
      <Box mb={3}>
        ...
        >
          Other Video Shoot Queue
        </Typography>

        <Typography sx={{ color: "#64748b", fontSize: "0.95rem", mt: 0.5 }}>
          Approved other video items ready for filming.
                    ...
                    {pendingItems.length === 0 ? (
                      <TableRow>
                        ...
                        >
                          ...
                          />
                          No other videos in shoot queue
                        </TableCell>
                      </TableRow>
                    ) : (
      ...
      >
        ...
        <DialogContent sx={{ pt: 3, px: 3 }}>
          ...
          {confirmTarget && (
            ...
            >
              ...
              >
                {confirmTarget.otherVideoId} · {confirmTarget.scriptType}
              </Typography>
        ...
        >
          ...
          <Button
            ...
            disabled={confirming}
            startIcon={
              confirming ? <CircularProgress size={16} color="inherit" /> : <CheckIcon />
            }
            sx={{
              bgcolor: "#059669",
              color: "#ffffff",
