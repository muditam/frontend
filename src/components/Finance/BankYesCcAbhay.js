    ...
    <Box sx={{ p: 3, bgcolor: "#f5f7fb", minHeight: "100vh", boxSizing: "border-box" }}>
      ...
      <Paper elevation={0} sx={{ mb: 2, px: 2, py: 2, borderRadius: 2, border: "1px solid #e0e3ef" }}>
        <Stack direction="row" spacing={1.5} flexWrap="wrap" alignItems="center">
          ...
          <TextField
            size="small"
            label="Search (Details/DrCr/Remarks)"
            value={q}
          ...
          <Button variant="contained" onClick={() => fetchData(0, rowsPerPage)} sx={{ textTransform: "none", borderRadius: 999 }}>
            Apply
          </Button>
          <Button variant="outlined" onClick={clearFilters} sx={{ textTransform: "none", borderRadius: 999 }}>
            Clear
          </Button>
        </Stack>
      </Paper>
                    ...
                    rows.map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell sx={{ minWidth: 380 }}>{row.transactionDetails}</TableCell>
                          <TableCell align="right">
                            {row.amount !== null && row.amount !== undefined ? formatNumber(row.amount) : ""}
                          </TableCell>
                          <TableCell sx={{ minWidth: 100 }}>{row.drCr}</TableCell>
                          <TableCell align="right">
                            {row.balance !== null && row.balance !== undefined ? formatNumber(row.balance) : ""}
                          </TableCell>
                          <TableCell sx={{ minWidth: 260 }}>{row.remarks}</TableCell>
                        </TableRow>
                      );
                    })
                  )}
